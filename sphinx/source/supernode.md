...
The conditions that contend successful are as the following:
...
Once contend successfully and your node keeps running, check the balance of **reward-address** and you will get minting reward every minite.
...
### Security Issue
For security reason, we suggest the supernode modify firewall rule and **not open 9922 in public network**, only for internal network using. If you want to use swagger client, you could startup another full node with 9922 port opened.
